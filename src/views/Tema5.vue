  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .col-12
        ul.lista-ul
          li.d-flex
            ...
            p.mb-0 <strong>Conexión tipo análoga:</strong> se utiliza en hogares, con un módem a través de la red telefónica; las señales digitales se transforman en análogas y este tipo de conexión ha ido disminuyendo su uso. 
          li.d-flex
            i.fas.fa-check.color_check_t3
            p.mb-0 <strong>ADSL:</strong> permite más alcance en la señal enviada por el operador, aunque presenta barreras de tipo físico, al ser enviada por #[i wifi]; este tipo de red es la más utilizada en las empresas por su velocidad, debido a que compensa algo en las restricciones con choque en muros.
          li.d-flex
            i.fas.fa-check.color_check_t3
    ...
    .row.mb-5
      .col-lg-5
        figure(data-aos='zoom-in')
          img(src='@/assets/template/tema5/t5-i1.png')
      .col-lg-7
        .row 
          .col-lg-12.mb-4
    ...
    .row.mb-5
      .col-lg-4.order-1.order-lg-1.mb-4.mb-lg-0(data-aos='zoom-in')
        figure
          img.m-auto(
            src='@/assets/template/tema5/t5-i4.png',
            alt='alt',
            style='width: 450px'
          )
    ...
    .row.mb-5
      .col-lg-12
        p Se distinguen básicamente dos tipos, cableadas e inalámbricas, pero entre ellas existe gran variedad de subtipos de conexión que también tienen una importancia relativa en el mercado, dado el nicho específico al que quiere llegar y necesidades de los clientes potenciales. Conozca los subtipos de los tipos de conectividad.

    p Conexiones inalámbricas:
          ...
          .col-lg-4
            .tarjeta.p-2
              .row.justify-content-center.mb-3
                ...
                .col-lg-12.tarjeta-color-st5.t-3-nivel2-tarjeta
                  .row.justify-content-center.t-3-nivel3-tarjeta.p-3
                    .col-lg-6.col-4.mb-3
                      img(
              ...
              .row.justify-content-center.mb-3
                ...
                .col-lg-12.tarjeta-color-st5.t-3-nivel2-tarjeta
                  .row.justify-content-center.t-3-nivel3-tarjeta.p-3
                    ...
                    h4.text-center Estándar #[i wifi] (Wireless-Fidelity)
    ...
    .row.mb-5
      .col-lg-5
        figure(data-aos='zoom-in')
          img(src='@/assets/template/tema5/t5-i5.png')
      .col-lg-7
        .row 
          .col-lg-12.mb-4
            p Es una nueva organización, donde por intereses y gustos comunes, personas, organizaciones o ambas, se conectan de forma remota, compartiendo estos intereses.
            |
            | Se permite el intercambio de información rápida y certera, a veces de tipo profesional o especializado, de acuerdo al tipo de red social y también como una simple actividad recreativa.
          .col-lg-12.mb-4
            .cajon.color_cajon_tema_3_1.p-4
