        ...
        figure(data-aos='zoom-in')
          .video
            iframe(
              width='560',
              height='315',
              src='https://www.youtube.com/embed/3l8ehmAcQ-E',
      ...
      .col-lg-12.mb-5
        .tarjeta.tarjeta_lineatiempot4.p-4
          LineaTiempoC.color-acento-contenido(text-small)
            .row.justify-content-center.mt-5(titulo='URL')
              ...
              .col-md-6
                figure
                  img(
                    src='@/assets/template/tema4/lineatiempo/t4-t1.png',
                    alt='Texto que describa la imagen'
                  )

            .row.justify-content-center.mt-5(titulo='Hipervínculos')
              .col-md-5.mb-4.mb-md-0
                ...
                p Sin embargo, sin importar la forma en que se presentan en la pantalla, todos los hipervínculos tienen en común el hecho de que, al hacer clic en ellos, nos desplazan a un lugar diferente del sitio web, donde originalmente se encuentran. Es decir, se enlazan a otros contenidos.


              .col-md-6
                figure
                  img(
                    src='@/assets/template/tema4/lineatiempo/t4-t2.png',
                    alt='Texto que describa la imagen'
                  )

            .row.justify-content-center.mt-5(titulo='<em>Cookies</em>')
              .col-md-5.mb-4.mb-md-0
              ...
              .col-md-6
                figure(data-aos='zoom-in')
                  img(
                    src='@/assets/template/tema4/lineatiempo/t4-t3.png',
                    alt='Texto que describa la imagen'
                  )

            .row.justify-content-center.mt-5(titulo='Favoritos e historial de navegación en la web')
              .col-md-5.mb-4.mb-md-0
              ...
              .col-md-6
                figure(data-aos='zoom-in')
                  img(
                    src='@/assets/template/tema4/lineatiempo/t4-t4.png',
                    alt='Texto que describa la imagen'
                  )
</template>
