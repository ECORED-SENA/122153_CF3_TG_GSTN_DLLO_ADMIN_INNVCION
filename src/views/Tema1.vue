          ...
          SlyderA(tipo='b')(data-aos='zoom-in')
            ...
            .row.justify-content-center.my-lg-4
              .col-md-6.mb-4.mb-md-0
                ...
                i stocks&nbsp;
                | en planta), mediante los programas de Planificación de recursos empresariales, ERP, y Técnica de revisión y evaluación de programas, PERT, entre otros. La información en planta es de suma importancia, para saber en qué momento se hacen requisiciones de materias primas e insumos, a qué puestos de trabajo se deben llevar y cuánto puede costar por unidad el producto en proceso. La información también debe dar cuota de los tiempos y requerimientos de recurso humano y maquinaria asociada a cada proceso.
            ...
            .row.justify-content-center.my-lg-4
              .col-md-6.mb-4.mb-md-0
                ...
                br
                br
                | La información que aquí llega, cruza con todos los departamentos, en costos generales y específicos en producción, los presupuestos de compras y adquisiciones, costos de nóminas directas e indirectas, costos de servicios de “tercerización” si existen, costos de publicidad y&nbsp;
                i marketing
    ...
    TabsC.color-acento-contenido.mb-5(data-aos='zoom-in')
      ...
      .py-3.py-md-4(titulo='Distribución')
        .row
          ...
          .col-md-6
            h4 Distribución
            p En este último proceso, se realiza el análisis pertinente con el usuario que interpreta la información para la toma final de decisiones. Esta información, a pesar de ser segmentada, se recomienda que llegue a diferentes departamentos a fin de que las decisiones que se tomen utilizando la información suministrada, sean consensuadas y en equipo.
